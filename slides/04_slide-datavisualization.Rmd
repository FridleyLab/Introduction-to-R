...
---
### [`r icons::icon_style(icons::fontawesome("link", style = "solid"), scale = 0.7, fill = "skyblue")` geom catalogue](https://ggplot2.tidyverse.org/reference/index.html#section-layers)
...
---
### [`r icons::icon_style(icons::fontawesome("link", style = "solid"), scale = 0.7, fill = "skyblue")` stat catalogue](https://ggplot2.tidyverse.org/reference/index.html#section-layers)
