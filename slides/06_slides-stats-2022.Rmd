...
<!-- ggplot(tcga, aes(x = DUOXA1_exp, y = DUOX1_exp, shape = gender, color = gender)) +  -->
<!--   geom_point() +  -->
...
<!-- lm(DUOX1_exp ~ DUOXA1_exp   , data = tcga, subset =  tcga$gender=="MALE")   -->
...
<!--  lm(DUOX1_exp ~ DUOXA1_exp  , data = tcga, subset =  tcga$gender=="FEMALE")   -->
