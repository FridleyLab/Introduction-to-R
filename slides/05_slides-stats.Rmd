---
title: "LeaRning about Statistics -YEAH!!!"
subtitle: "Heck YA! "
author: 
  - Zachary Thompson 
...
r4<-Rclassdata %>% correlation::cor_test("AAMP_exp",
                                          "A1CF_exp",
                                          method = c("pearson") )
...
ggplot(Rclassdata) + aes(log(AAMP_exp),  log(A1CF_exp) ) + geom_point()
...
```{r comment=NA}
 knitr::kable(bind_rows(r1,r2,r3,r4), format = 'html') %>%
