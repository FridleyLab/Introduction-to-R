...
This is a XXX week course designed to introduce future users to R and Rstudio.
We will cover data cleaning using the `tidyverse`, creating visuals with `ggplot`,
bsic statistical analysis and writing documents with `Rmarkdown`. In the end 
...
This course is taught by members of Moffitt faculty including Jordan Creed, a 
data analyst in the Department of Biostatistics, Garrick Aden-Buie, a scientific
programmer with Data Science Core, Zachary Thompson and Ram Thappa, biostatisticians
in the Bioinformatics and Biostatistics Core. 
